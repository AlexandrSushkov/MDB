...
import 'package:mdb/src/ui/ios/movie_details_screen_ios.dart';
import 'package:mdb/src/utils/wigdet/page_transformer.dart';
import 'package:mdb/src/utils/constants.dart';
import 'package:vector_math/vector_math_64.dart';


class MoviePageViewerItemIos extends StatelessWidget {
  MoviePageViewerItemIos({
    @required this.movie,
...
//                _buildTextContainer(context),
  ...
  Future<void> _showProductDetailsPage(BuildContext context) async {
    Navigator.push(context, CupertinoPageRoute(builder: (context) => MovieDetailsScreenIos(movie: movie)));
  }
